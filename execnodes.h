...
typedef struct HashJoinState
{
	...
	TupleTableSlot *hj_FirstInnerTupleSlot; //CSI3130: added a slot for the first tuple in the inner relation
	TupleTableSlot *hj_FirstOuterTupleSlot;
	bool		hj_NeedNewInner; //CSI3130: added bool to indicate if a new inner tuple is needed
	bool		hj_NeedNewOuter;
	bool		hj_MatchedInner; //CSI3130: added bool to indicate if an inner tuple has been matched
